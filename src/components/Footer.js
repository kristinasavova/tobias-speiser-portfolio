    ...
    return (
        <footer>
            <ul className='footer-list'>
                <li>GET IN TOUCH<br />tobiasspeiser@hotmail.com</li>
                <li>
                    <Link to='/about'><u>ABOUT ME</u></Link>
                </li>
                <li>
                    <a href='https://www.linkedin.com/in/tobias-speiser-251556153'>
                        <svg 
                            ...
                            viewBox="0 0 24 24">
                            <path 
                                d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 
